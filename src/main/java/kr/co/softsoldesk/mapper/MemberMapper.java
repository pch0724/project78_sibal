...
public interface MemberMapper {
	...
	@Select("select ID, Name, Password, Birth_Date, Phone_num, Emergency_Contact, Address, Entrance_Date, Email, R_id, first_login, member_file from member where ID = #{ID} and Password = #{Password}")
	...
	@Select("select ID, Name, Password, Birth_date, Phone_num, Emergency_Contact, Address, Entrance_Date, Email, R_id, member_file from member where ID = #{ID}")
