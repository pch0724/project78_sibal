...
<body>
	...
	<section class="sec">
		<div class="contents">
			...
			<!-- 강의선택  -->
			<p>
				<span style="padding: 0.5em 0.6em; color: #168; font-size: 16pt;"><b>강의
						선택</b></span>
			</p>
			<table class="lec-tbl">
			...
			<c:forEach var="i" begin="0" end="${size }">
				<section id="LecSection${i }" style="display: none">
					...
					<p>
						<span style="padding: 0.5em 0.6em; color: #168; font-size: 16pt;"><b>과목
								정보</b></span>
					</p>
					<table class="lec-tbl">
					...
					<div
						...
						<p>
							<span style="padding: 0.5em 0.6em; color: #168; font-size: 16pt;"><b>성적
									조회</b></span>
						</p>
					</div>
					...
					<div class="input-info-tbl">
						...
						<div class="gradeinput-info" id="tr" style="font-weight: bold">
							...
							<div class="rank" id="th" style="width: 8%">
								<input class="info-button" type="button" value="순위" onclick="sortDivsByRank()" 
					...
					<div class="input-info-tbl">
						<section class="overflow-section" >
							...
							<c:forEach var="grade1" items="${stdList[i] }">
								<div class="gradeinput-info" id="tr" align="center">
									...
									<div class="attendance" id="td" style="width: 4%" align="center">
										<div style="float:left;" >${grade1.at_score }</div>
										<div style="color: gray; font-size: 11px; float:left; margin-top: 5px;">&nbsp;/20</div>
									</div>
									<div class="midterm" id="td" style="width: 4%" align="center">
										<div style="float:left;">${grade1.m_score }</div>
										<div style="color: gray; font-size: 11px; float:left; margin-top: 5px;">&nbsp;/30</div>
									</div>
									<div class="final" id="td" style="width: 4%" align="center">
										<div style="float:left;">${grade1.f_score }</div>
										<div style="color: gray; font-size: 11px; float:left; margin-top: 5px;">&nbsp;/30</div>
									</div>
									<div class="assignment" id="td" style="width: 4%" align="center">
										<div style="float:left;">${grade1.a_score }</div>
										<div style="color: gray; font-size: 11px; float:left; margin-top: 5px;">&nbsp;/30</div>
									</div>
									<div class="total" id="td" style="width: 4%" align="center">
										<div style="float:left;">${grade1.at_score + grade1.m_score +grade1.f_score + grade1.a_score}</div>
										<div style="color: gray; font-size: 11px; float:left; margin-top: 5px;">&nbsp;/100</div>
									</div>
									<div class="gpa" id="td" style="width: 4%">${grade1.gpacalc }</div>
									<div class="gpa" id="td" style="width: 4%">${grade1.gradeLetter }</div>
									<div class="rank" id="td" style="width: 4%" align="center">
										<div style="float:left;">${grade1.rank }</div>
										<div style="color: gray; font-size: 11px; float:left; margin-top: 5px;">&nbsp;/${counts[i] }</div>
									</div>
								</div>
							</c:forEach>
   ...
   function sortDivsByRank() {
     const container = document.querySelector('.overflow-section');
     const divs = Array.from(container.querySelectorAll('.gradeinput-info'));

     divs.sort((a, b) => {
       const rankADivText = a.querySelector('.rank > div:nth-child(1)').textContent;
       const rankBDivText = b.querySelector('.rank > div:nth-child(1)').textContent;
       const rankA = parseInt(rankADivText);
       const rankB = parseInt(rankBDivText);
       return sortDescending ? rankA - rankB : rankB - rankA;
     });
